...
require("lazy").setup({
    spec = {
        ...
        { "LazyVim/LazyVim", import = "lazyvim.plugins.extras.ai.copilot" },
        { "LazyVim/LazyVim", import = "lazyvim.plugins.extras.ai.copilot-chat" },
        ...
        { "LazyVim/LazyVim", import = "lazyvim.plugins.extras.lang.zig" },
